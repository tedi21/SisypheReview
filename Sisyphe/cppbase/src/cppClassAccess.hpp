...
private :
	std::vector< boost::shared_ptr< _CppClass<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _CppClass<EncodingT> > getOneCppClass(int identifier) const;
	...
	*/
	...
	@return The CppClass object.
	*/
	 boost::shared_ptr< _CppClass<EncodingT> > selectOneCppClass(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppInheritance(boost::shared_ptr< _CppClass<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppInheritance data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppFunction(boost::shared_ptr< _CppClass<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppFunction data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppAttribute(boost::shared_ptr< _CppClass<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppAttribute data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
