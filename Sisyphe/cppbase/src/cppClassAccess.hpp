...
private :
	using backup_t = std::set< boost::shared_ptr< _CppClass<EncodingT> >, typename _CppClass<EncodingT>::CppClassIDInferior >;
	backup_t m_backup;
...
public :
	...
	*/
	 std::vector< boost::shared_ptr< _CppClass<EncodingT> > > getManyCppClasss(typename EncodingT::string_t const&  filter) const;
	/** Returns all CppClass objects from database.
	@return List of CppClass objects.
	*/
	 std::vector< boost::shared_ptr< _CppClass<EncodingT> > > getAllCppClasss() const;
	/** Returns CppClass object from database.
	@param identifier 
	@return The CppClass object.
	*/
	 boost::shared_ptr< _CppClass<EncodingT> > getOneCppClass(long long identifier) const;
	/** Returns CppClass objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of CppClass objects.
	*/
	 std::vector< boost::shared_ptr< _CppClass<EncodingT> > > selectManyCppClasss(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns CppClass object from database. Data are locked for update.
	@param identifier 
	@param nowait Asynchonous call.
	@return The CppClass object.
	*/
	 boost::shared_ptr< _CppClass<EncodingT> > selectOneCppClass(long long identifier, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedCppClass(boost::shared_ptr< _CppClass<EncodingT> > o) const;
	/** Cancel the selection. The CppClass object cannot be updated or deleted from database.
	*/
	 void cancelSelection();
	/** Fills encapsulationClass data from database.
	@param o The CppClass object.
	*/
	 void fillEncapsulationClass(boost::shared_ptr< _CppClass<EncodingT> > o);
	/** Fills cppFile data from database.
	@param o The CppClass object.
	*/
	 void fillCppFile(boost::shared_ptr< _CppClass<EncodingT> > o);
	/** Fills cppInheritance data from database.
	@param o The CppClass object.
	@param nowait Asynchronous call.
	*/
	 void fillAllCppInheritances(boost::shared_ptr< _CppClass<EncodingT> > o, bool nowait = false);
	/** Fills cppInheritance data from database.
	@param o The CppClass object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneCppInheritance(boost::shared_ptr< _CppClass<EncodingT> > o, long long identifier, bool nowait = false);
	/** Fills cppInheritance data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyCppInheritances(boost::shared_ptr< _CppClass<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Fills cppFunction data from database.
	@param o The CppClass object.
	@param nowait Asynchronous call.
	*/
	 void fillAllCppFunctions(boost::shared_ptr< _CppClass<EncodingT> > o, bool nowait = false);
	/** Fills cppFunction data from database.
	@param o The CppClass object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneCppFunction(boost::shared_ptr< _CppClass<EncodingT> > o, long long identifier, bool nowait = false);
	/** Fills cppFunction data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyCppFunctions(boost::shared_ptr< _CppClass<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Fills internClasse data from database.
	@param o The CppClass object.
	@param nowait Asynchronous call.
	*/
	 void fillAllInternClasses(boost::shared_ptr< _CppClass<EncodingT> > o, bool nowait = false);
	/** Fills internClasse data from database.
	@param o The CppClass object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneInternClasse(boost::shared_ptr< _CppClass<EncodingT> > o, long long identifier, bool nowait = false);
	/** Fills internClasse data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyInternClasses(boost::shared_ptr< _CppClass<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Fills cppAttribute data from database.
	@param o The CppClass object.
	@param nowait Asynchronous call.
	*/
	 void fillAllCppAttributes(boost::shared_ptr< _CppClass<EncodingT> > o, bool nowait = false);
	/** Fills cppAttribute data from database.
	@param o The CppClass object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneCppAttribute(boost::shared_ptr< _CppClass<EncodingT> > o, long long identifier, bool nowait = false);
	/** Fills cppAttribute data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyCppAttributes(boost::shared_ptr< _CppClass<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Fills cppEnum data from database.
	@param o The CppClass object.
	@param nowait Asynchronous call.
	*/
	 void fillAllCppEnums(boost::shared_ptr< _CppClass<EncodingT> > o, bool nowait = false);
	/** Fills cppEnum data from database.
	@param o The CppClass object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneCppEnum(boost::shared_ptr< _CppClass<EncodingT> > o, long long identifier, bool nowait = false);
	/** Fills cppEnum data from database.
	@param o The CppClass object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyCppEnums(boost::shared_ptr< _CppClass<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Returns whether CppClass data are altered from database.
	@param o The CppClass object.
	@return True if data CppClass have been altered.
	*/
	 bool isModifiedCppClass(boost::shared_ptr< _CppClass<EncodingT> > o) const;
	/** Updates CppClass data to database.
	@param o The CppClass object.
	*/
	 void updateCppClass(boost::shared_ptr< _CppClass<EncodingT> > o);
	/** Inserts CppClass data to database.
	@param o The CppClass object.
	*/
	 void insertCppClass(boost::shared_ptr< _CppClass<EncodingT> > o);
	/** Deletes CppClass data to database.
	@param o The CppClass object.
	*/
	 void deleteCppClass(boost::shared_ptr< _CppClass<EncodingT> > o);
