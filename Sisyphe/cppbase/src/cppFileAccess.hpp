...
private :
	std::vector< boost::shared_ptr< _CppFile<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _CppFile<EncodingT> > getOneCppFile(boost::shared_ptr< _TextFile<EncodingT> > textFile) const;
	...
	*/
	...
	@return The CppFile object.
	*/
	 boost::shared_ptr< _CppFile<EncodingT> > selectOneCppFile(boost::shared_ptr< _TextFile<EncodingT> > textFile, bool nowait = false, bool addition = false);
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppDeclarationFunction(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppDeclarationFunction data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppDefinitionFunction(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppDefinitionFunction data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppInclude(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppInclude data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppClass(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppClass data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppEnum(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppEnum data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCMacro(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cMacro data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillAllDebugFileInfos(boost::shared_ptr< _CppFile<EncodingT> > o, bool nowait = false);
	/** Fills debugFileInfo data from database.
	@param o The CppFile object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneDebugFileInfo(boost::shared_ptr< _CppFile<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills debugFileInfo data from database.
	@param o The CppFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyDebugFileInfos(boost::shared_ptr< _CppFile<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	...
	*/
	...
	@param o The CppFile object.
	*/
	 void deleteCppFile(boost::shared_ptr< _CppFile<EncodingT> > o, bool deleteid = true);
