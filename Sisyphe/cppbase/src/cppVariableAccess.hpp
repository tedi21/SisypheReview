...
private :
	std::vector< shared_ptr< _CppVariable<EncodingT> > > m_backup;
...
public :
	...
	*/
	 std::vector< shared_ptr< _CppVariable<EncodingT> > > getManyCppVariables(typename EncodingT::string_t const&  filter) const;
	/** Returns all CppVariable objects from database.
	@return List of CppVariable objects.
	*/
	 std::vector< shared_ptr< _CppVariable<EncodingT> > > getAllCppVariables() const;
	/** Returns CppVariable object from database.
	@param identifier 
	@return The CppVariable object.
	*/
	 shared_ptr< _CppVariable<EncodingT> > getOneCppVariable(int identifier) const;
	/** Returns CppVariable objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of CppVariable objects.
	*/
	 std::vector< shared_ptr< _CppVariable<EncodingT> > > selectManyCppVariables(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns CppVariable object from database. Data are locked for update.
	@param identifier 
	@param nowait Asynchonous call.
	@return The CppVariable object.
	*/
	 shared_ptr< _CppVariable<EncodingT> > selectOneCppVariable(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedCppVariable(shared_ptr< _CppVariable<EncodingT> > o) const;
	...
	*/
	...
	@param o The CppVariable object.
	*/
	 void fillCppFunction(shared_ptr< _CppVariable<EncodingT> > o);
	/** Returns whether CppVariable data are altered from database.
	@param o The CppVariable object.
	@return True if data CppVariable have been altered.
	*/
	 bool isModifiedCppVariable(shared_ptr< _CppVariable<EncodingT> > o) const;
	/** Updates CppVariable data to database.
	@param o The CppVariable object.
	*/
	 void updateCppVariable(shared_ptr< _CppVariable<EncodingT> > o);
	/** Inserts CppVariable data to database.
	@param o The CppVariable object.
	*/
	 void insertCppVariable(shared_ptr< _CppVariable<EncodingT> > o);
	/** Deletes CppVariable data to database.
	@param o The CppVariable object.
	*/
	 void deleteCppVariable(shared_ptr< _CppVariable<EncodingT> > o);
