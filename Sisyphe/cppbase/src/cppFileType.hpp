...
private :
	...
	typedef std::vector< shared_ptr< _CppFile<EncodingT> > >	vector_cppFile;
...
public :
	...
	*/
	shared_ptr< _CppFile<EncodingT> >& getCppFileAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFile<EncodingT> > getCppFileAt(size_t n) const 
	{
		return m_cppFiles.at(n);
	}
	...
	*/
	void addCppFile(shared_ptr< _CppFile<EncodingT> > o)  
	{
	...
	*/
	CppFileIterator insertCppFile(CppFileIterator pos, shared_ptr< _CppFile<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppFiles, pos), static_cast< shared_ptr< _CppFile<EncodingT> >(*)(shared_ptr< _CppFile<EncodingT> >) >(copy_ptr));
	}
