...
public :
	...
	*/
	...
	bool operator()(shared_ptr< _CppInclude<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppInclude<EncodingT> > elem1, shared_ptr< _CppInclude<EncodingT> > elem2) const 
	{
