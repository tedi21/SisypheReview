...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppInclude<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppInclude<EncodingT>::CppIncludeIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppInclude<EncodingT> >& elem1, const boost::shared_ptr< _CppInclude<EncodingT> >& elem2) const 
	{
