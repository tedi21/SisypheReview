...
protected :
	...
	*/
	_DebugFunctionInfo(int identifier,
				...
				int debugStart,
				int debugEnd,
				const typename EncodingT::string_t& debugReturnType)
...
public :
	...
	*/
	...
	: m_identifier(-1),
	  ...
	  m_debugStart(0),
	  m_debugEnd(0),
	  m_debugReturnType(EncodingT::EMPTY)
	{
		m_logger = &Category::getInstance(LOGNAME);
		m_logger->debugStream() << "constructor _DebugFunctionInfo ";
	}
	...
	*/
	...
	: m_identifier(elem.m_identifier),
	  ...
	  m_debugReturnType(elem.m_debugReturnType),
	...
	*/
	...
	/** Returns a const reference to the element <i>debugReturnType</i> in DebugFunctionInfo.
	@return 
	*/
	const typename EncodingT::string_t& getDebugReturnType() const 
	{
		return m_debugReturnType;
	}

	/** Sets a value of the element <i>debugReturnType</i> in DebugFunctionInfo.
	@param debugReturnType 
	*/
	void setDebugReturnType(const typename EncodingT::string_t& debugReturnType)  
	{
		m_debugReturnType = debugReturnType;
	}
	...
	*/
	ostream& printConsole(ostream& o) const 
	{
		return o << "DebugFunctionInfo" << endl
		         ...
		         << "debugEnd : " << m_debugEnd << endl
		         << "debugReturnType : " << A(m_debugReturnType);
	}
	...
	*/
	...
	class DebugReturnTypeEquality;
	class DebugReturnTypeInferior;
	class DebugReturnTypeSuperior;
};
