...
private :
	std::vector< shared_ptr< _TextFile<EncodingT> > > m_backup;
...
public :
	...
	*/
	 std::vector< shared_ptr< _TextFile<EncodingT> > > getManyTextFiles(typename EncodingT::string_t const&  filter) const;
	/** Returns all TextFile objects from database.
	@return List of TextFile objects.
	*/
	 std::vector< shared_ptr< _TextFile<EncodingT> > > getAllTextFiles() const;
	/** Returns TextFile object from database.
	@param rowid 
	@return The TextFile object.
	*/
	 shared_ptr< _TextFile<EncodingT> > getOneTextFile(long long rowid) const;
	/** Returns TextFile objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of TextFile objects.
	*/
	 std::vector< shared_ptr< _TextFile<EncodingT> > > selectManyTextFiles(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns TextFile object from database. Data are locked for update.
	@param rowid 
	@param nowait Asynchonous call.
	@return The TextFile object.
	*/
	 shared_ptr< _TextFile<EncodingT> > selectOneTextFile(long long rowid, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedTextFile(shared_ptr< _TextFile<EncodingT> > o) const;
	/** Cancel the selection. The TextFile object cannot be updated or deleted from database.
	*/
	 void cancelSelection();
	/** Fills textNotice data from database.
	@param o The TextFile object.
	@param nowait Asynchronous call.
	*/
	 void fillAllTextNotices(shared_ptr< _TextFile<EncodingT> > o, bool nowait = false);
	/** Fills textNotice data from database.
	@param o The TextFile object.
	@param rowid 
	@param nowait Asynchronous call.
	*/
	 void fillOneTextNotice(shared_ptr< _TextFile<EncodingT> > o, long long rowid, bool nowait = false);
	/** Fills textNotice data from database.
	@param o The TextFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyTextNotices(shared_ptr< _TextFile<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Returns whether TextFile data are altered from database.
	@param o The TextFile object.
	@return True if data TextFile have been altered.
	*/
	 bool isModifiedTextFile(shared_ptr< _TextFile<EncodingT> > o) const;
	/** Updates TextFile data to database.
	@param o The TextFile object.
	*/
	 void updateTextFile(shared_ptr< _TextFile<EncodingT> > o);
	/** Inserts TextFile data to database.
	@param o The TextFile object.
	*/
	 void insertTextFile(shared_ptr< _TextFile<EncodingT> > o);
	/** Deletes TextFile data to database.
	@param o The TextFile object.
	*/
	 void deleteTextFile(shared_ptr< _TextFile<EncodingT> > o);
