...
private :
	std::vector< boost::shared_ptr< _TextFile<EncodingT> > > m_backup;
...
public :
	...
	*/
	 void fillAllTextNotices(boost::shared_ptr< _TextFile<EncodingT> > o, bool nowait = false);
	/** Fills textNotice data from database.
	@param o The TextFile object.
	@param rowid 
	@param nowait Asynchronous call.
	*/
	 void fillOneTextNotice(boost::shared_ptr< _TextFile<EncodingT> > o, long long rowid, bool nowait = false);
	/** Fills textNotice data from database.
	@param o The TextFile object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyTextNotices(boost::shared_ptr< _TextFile<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
