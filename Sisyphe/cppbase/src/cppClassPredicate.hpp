...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppClass<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppClass<EncodingT>::CppClassIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppClass<EncodingT> >& elem1, const boost::shared_ptr< _CppClass<EncodingT> >& elem2) const 
	{
