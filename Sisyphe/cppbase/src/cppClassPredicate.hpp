...
public :
	...
	@param identifier 
	*/
	CppClassIDEquality(int identifier)
	...
	bool operator()(shared_ptr< _CppClass<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppClass<EncodingT> > elem1, shared_ptr< _CppClass<EncodingT> > elem2) const 
	{
...
public :
	...
	@param isInterface 
	*/
	IsInterfaceEquality(int isInterface)
...
public :
	...
	@param isAbstract 
	*/
	IsAbstractEquality(int isAbstract)
