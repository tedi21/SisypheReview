...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _DebugStubInfo<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _DebugStubInfo<EncodingT>::DebugStubInfoIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _DebugStubInfo<EncodingT> >& elem1, const boost::shared_ptr< _DebugStubInfo<EncodingT> >& elem2) const 
	{
