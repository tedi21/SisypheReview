...
private :
	...
	int	m_startBlock;
	int	m_lengthBlock;
	typedef std::vector< shared_ptr< _CppEnumConstant<EncodingT> > >	vector_cppEnumConstant;
...
public :
	...
	*/
	shared_ptr< _CppEnumConstant<EncodingT> >& getCppEnumConstantAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppEnumConstant<EncodingT> > getCppEnumConstantAt(size_t n) const 
	{
		return m_cppEnumConstants.at(n);
	}
	...
	*/
	void addCppEnumConstant(shared_ptr< _CppEnumConstant<EncodingT> > o)  
	{
	...
	*/
	CppEnumConstantIterator insertCppEnumConstant(CppEnumConstantIterator pos, shared_ptr< _CppEnumConstant<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppEnumConstants, pos), static_cast< shared_ptr< _CppEnumConstant<EncodingT> >(*)(shared_ptr< _CppEnumConstant<EncodingT> >) >(copy_ptr));
	}
