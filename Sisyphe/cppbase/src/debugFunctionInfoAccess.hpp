...
private :
	std::vector< shared_ptr< _DebugFunctionInfo<EncodingT> > > m_backup;
...
public :
	...
	*/
	 std::vector< shared_ptr< _DebugFunctionInfo<EncodingT> > > getManyDebugFunctionInfos(typename EncodingT::string_t const&  filter) const;
	/** Returns all DebugFunctionInfo objects from database.
	@return List of DebugFunctionInfo objects.
	*/
	 std::vector< shared_ptr< _DebugFunctionInfo<EncodingT> > > getAllDebugFunctionInfos() const;
	/** Returns DebugFunctionInfo object from database.
	@param identifier 
	@return The DebugFunctionInfo object.
	*/
	 shared_ptr< _DebugFunctionInfo<EncodingT> > getOneDebugFunctionInfo(int identifier) const;
	/** Returns DebugFunctionInfo objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of DebugFunctionInfo objects.
	*/
	 std::vector< shared_ptr< _DebugFunctionInfo<EncodingT> > > selectManyDebugFunctionInfos(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns DebugFunctionInfo object from database. Data are locked for update.
	@param identifier 
	@param nowait Asynchonous call.
	@return The DebugFunctionInfo object.
	*/
	 shared_ptr< _DebugFunctionInfo<EncodingT> > selectOneDebugFunctionInfo(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o) const;
	...
	*/
	...
	@param o The DebugFunctionInfo object.
	*/
	 void fillCppFunction(shared_ptr< _DebugFunctionInfo<EncodingT> > o);
	/** Fills debugVariableInfo data from database.
	@param o The DebugFunctionInfo object.
	@param nowait Asynchronous call.
	*/
	 void fillAllDebugVariableInfos(shared_ptr< _DebugFunctionInfo<EncodingT> > o, bool nowait = false);
	/** Fills debugVariableInfo data from database.
	@param o The DebugFunctionInfo object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneDebugVariableInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills debugVariableInfo data from database.
	@param o The DebugFunctionInfo object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyDebugVariableInfos(shared_ptr< _DebugFunctionInfo<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Returns whether DebugFunctionInfo data are altered from database.
	@param o The DebugFunctionInfo object.
	@return True if data DebugFunctionInfo have been altered.
	*/
	 bool isModifiedDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o) const;
	/** Updates DebugFunctionInfo data to database.
	@param o The DebugFunctionInfo object.
	*/
	 void updateDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o);
	/** Inserts DebugFunctionInfo data to database.
	@param o The DebugFunctionInfo object.
	*/
	 void insertDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o);
	/** Deletes DebugFunctionInfo data to database.
	@param o The DebugFunctionInfo object.
	*/
	 void deleteDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > o);
