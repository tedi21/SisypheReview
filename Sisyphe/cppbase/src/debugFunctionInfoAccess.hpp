...
private :
	std::vector< boost::shared_ptr< _DebugFunctionInfo<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _DebugFunctionInfo<EncodingT> > getOneDebugFunctionInfo(int identifier) const;
	...
	*/
	...
	@return The DebugFunctionInfo object.
	*/
	 boost::shared_ptr< _DebugFunctionInfo<EncodingT> > selectOneDebugFunctionInfo(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	...
	@param o The DebugFunctionInfo object.
	*/
	 void fillCppFunction(boost::shared_ptr< _DebugFunctionInfo<EncodingT> > o);
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneDebugVariableInfo(boost::shared_ptr< _DebugFunctionInfo<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills debugVariableInfo data from database.
	@param o The DebugFunctionInfo object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
