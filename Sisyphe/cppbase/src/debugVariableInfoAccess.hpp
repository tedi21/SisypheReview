...
private :
	std::vector< boost::shared_ptr< _DebugVariableInfo<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _DebugVariableInfo<EncodingT> > getOneDebugVariableInfo(int identifier) const;
	...
	*/
	...
	@return The DebugVariableInfo object.
	*/
	 boost::shared_ptr< _DebugVariableInfo<EncodingT> > selectOneDebugVariableInfo(int identifier, bool nowait = false, bool addition = false);
