...
public :
	...
	*/
	...
	bool operator()(shared_ptr< _TextNotice<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _TextNotice<EncodingT> > elem1, shared_ptr< _TextNotice<EncodingT> > elem2) const 
	{
