...
private :
	...
	shared_ptr< _DebugFunctionInfo<EncodingT> >	m_debugFunctionInfo;
	Category*	m_logger;
...
protected :
	...
	*/
	_DebugVariableInfo(int identifier,
				...
				const typename EncodingT::string_t& type,
...
public :
	...
	*/
	...
	/** Returns a const reference to the element <i>type</i> in DebugVariableInfo.
	@return 
	*/
	...
	/** Sets a value of the element <i>type</i> in DebugVariableInfo.
	@param type 
	*/
	void setType(const typename EncodingT::string_t& type)  
	{
		m_type = type;
	}
	...
	*/
	...
	@return 
	*/
	shared_ptr< _DebugFunctionInfo<EncodingT> > getDebugFunctionInfo() const 
	{
	...
	*/
	void setDebugFunctionInfo(shared_ptr< _DebugFunctionInfo<EncodingT> > debugFunctionInfo)  
	{
