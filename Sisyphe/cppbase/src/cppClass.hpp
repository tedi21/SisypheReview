...
private :
	...
	int	m_startBlock;
	int	m_lengthBlock;
	typedef std::vector< shared_ptr< _CppInheritance<EncodingT> > >	vector_cppInheritance;
	vector_cppInheritance	m_cppInheritances;
	typedef std::vector< shared_ptr< _CppFunction<EncodingT> > >	vector_cppFunction;
	vector_cppFunction	m_cppFunctions;
	typedef std::vector< shared_ptr< _CppAttribute<EncodingT> > >	vector_cppAttribute;
...
public :
	...
	*/
	shared_ptr< _CppInheritance<EncodingT> >& getCppInheritanceAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppInheritance<EncodingT> > getCppInheritanceAt(size_t n) const 
	{
		return m_cppInheritances.at(n);
	}
	...
	*/
	void addCppInheritance(shared_ptr< _CppInheritance<EncodingT> > o)  
	{
	...
	*/
	CppInheritanceIterator insertCppInheritance(CppInheritanceIterator pos, shared_ptr< _CppInheritance<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppInheritances, pos), static_cast< shared_ptr< _CppInheritance<EncodingT> >(*)(shared_ptr< _CppInheritance<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFunction<EncodingT> >& getCppFunctionAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFunction<EncodingT> > getCppFunctionAt(size_t n) const 
	{
		return m_cppFunctions.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppFunction(shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppFunctionIterator insertCppFunction(CppFunctionIterator pos, shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppFunctions, pos), static_cast< shared_ptr< _CppFunction<EncodingT> >(*)(shared_ptr< _CppFunction<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppAttribute<EncodingT> >& getCppAttributeAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppAttribute<EncodingT> > getCppAttributeAt(size_t n) const 
	{
		return m_cppAttributes.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppAttribute(shared_ptr< _CppAttribute<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppAttributeIterator insertCppAttribute(CppAttributeIterator pos, shared_ptr< _CppAttribute<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppAttributes, pos), static_cast< shared_ptr< _CppAttribute<EncodingT> >(*)(shared_ptr< _CppAttribute<EncodingT> >) >(copy_ptr));
	}
