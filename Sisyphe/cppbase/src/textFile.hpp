...
private :
	...
	typedef std::vector< shared_ptr< _TextNotice<EncodingT> > >	vector_textNotice;
...
public :
	...
	*/
	shared_ptr< _TextNotice<EncodingT> >& getTextNoticeAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _TextNotice<EncodingT> > getTextNoticeAt(size_t n) const 
	{
		return m_textNotices.at(n);
	}
	...
	*/
	void addTextNotice(shared_ptr< _TextNotice<EncodingT> > o)  
	{
	...
	*/
	TextNoticeIterator insertTextNotice(TextNoticeIterator pos, shared_ptr< _TextNotice<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_textNotices, pos), static_cast< shared_ptr< _TextNotice<EncodingT> >(*)(shared_ptr< _TextNotice<EncodingT> >) >(copy_ptr));
	}
