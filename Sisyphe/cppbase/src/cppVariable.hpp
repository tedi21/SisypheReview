...
public :
	...
	*/
	...
	/** Creates a copy of elem as the content for the CppVariable object.
	@param elem A CppVariable object containing elements of the same type.
	*/
	_CppVariable(const _CppVariable<EncodingT>& elem)
	: m_identifier(elem.m_identifier),
	  m_varType(elem.m_varType),
	  m_name(elem.m_name),
	...
	{
		m_logger = &Category::getInstance(LOGNAME);
		m_logger->debugStream() << "constructor _CppVariable " << ": copy";
	}

	/** Assigns a copy of elem as the new content for the CppVariable object.
	@param elem A CppVariable object containing elements of the same type.
	@return *this
	*/
	_CppVariable<EncodingT>& operator=(const _CppVariable<EncodingT>& elem)  
	{
		m_identifier = elem.m_identifier;
		m_varType = elem.m_varType;
		m_name = elem.m_name;
