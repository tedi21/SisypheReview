...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _TextFile<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _TextFile<EncodingT>::TextFileIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _TextFile<EncodingT> >& elem1, const boost::shared_ptr< _TextFile<EncodingT> >& elem2) const 
	{
		return (elem1 != NULL && elem2 != NULL && elem1->getRowid() < elem2->getRowid());
	}
