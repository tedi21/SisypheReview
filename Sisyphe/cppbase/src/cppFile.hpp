...
public :
	...
	*/
	...
	/** Returns a const reference to the element <i>isTracked</i> in CppFile.
	@return 
	*/
	long long getIsTracked() const 
	{
		return m_isTracked;
	}

	/** Sets a value of the element <i>isTracked</i> in CppFile.
	@param isTracked 
	*/
	void setIsTracked(long long isTracked)  
	{
		m_isTracked = isTracked;
	}
	...
	*/
	ostream& printConsole(ostream& o) const 
	{
		return o << "CppFile" << endl
		         ...
		         << "hash : " << m_hash << endl
		         << "analyzed : " << m_analyzed << endl
		         << "isTracked : " << m_isTracked;
	}
	...
	*/
	...
	class IsTrackedEquality;
	class IsTrackedInferior;
	class IsTrackedSuperior;
};
