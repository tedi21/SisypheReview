...
private :
	...
	shared_ptr< _CppFileType<EncodingT> >	m_cppFileType;
	int	m_linesCount;
	typedef std::vector< shared_ptr< _CppFunction<EncodingT> > >	vector_cppDeclarationFunction;
	vector_cppDeclarationFunction	m_cppDeclarationFunctions;
	typedef std::vector< shared_ptr< _CppFunction<EncodingT> > >	vector_cppDefinitionFunction;
	vector_cppDefinitionFunction	m_cppDefinitionFunctions;
	typedef std::vector< shared_ptr< _CppInclude<EncodingT> > >	vector_cppInclude;
	vector_cppInclude	m_cppIncludes;
	typedef std::vector< shared_ptr< _CppClass<EncodingT> > >	vector_cppClass;
	vector_cppClass	m_cppClasss;
	typedef std::vector< shared_ptr< _CppEnum<EncodingT> > >	vector_cppEnum;
	vector_cppEnum	m_cppEnums;
	typedef std::vector< shared_ptr< _CMacro<EncodingT> > >	vector_cMacro;
	vector_cMacro	m_cMacros;
	typedef std::vector< shared_ptr< _DebugFileInfo<EncodingT> > >	vector_debugFileInfo;
...
public :
	...
	*/
	...
	@param linesCount 
	*/
	_CppFile(shared_ptr< _TextFile<EncodingT> > textFile,
				const typename EncodingT::string_t& path,
				const typename EncodingT::string_t& name,
				int linesCount)
	: m_textFile(copy_ptr(textFile)),
	  m_path(path),
	  m_name(name),
	...
	/** Creates a copy of elem as the content for the CppFile object.
	@param elem A CppFile object containing elements of the same type.
	*/
	_CppFile(const _CppFile<EncodingT>& elem)
	: m_textFile(copy_ptr(elem.m_textFile)),
	  m_path(elem.m_path),
	  m_name(elem.m_name),
	  m_cppFileType(elem.m_cppFileType),
	  m_linesCount(elem.m_linesCount),
	  m_cppDeclarationFunctions(copy_ptr(elem.m_cppDeclarationFunctions)),
	  m_cppDefinitionFunctions(copy_ptr(elem.m_cppDefinitionFunctions)),
	  m_cppIncludes(copy_ptr(elem.m_cppIncludes)),
	  m_cppClasss(copy_ptr(elem.m_cppClasss)),
	  m_cppEnums(copy_ptr(elem.m_cppEnums)),
	  m_cMacros(copy_ptr(elem.m_cMacros)),
	  m_debugFileInfos(copy_ptr(elem.m_debugFileInfos))
	{
		m_logger = &Category::getInstance(LOGNAME);
		m_logger->debugStream() << "constructor _CppFile " << ": copy";
	}

	/** Assigns a copy of elem as the new content for the CppFile object.
	@param elem A CppFile object containing elements of the same type.
	@return *this
	*/
	_CppFile<EncodingT>& operator=(const _CppFile<EncodingT>& elem)  
	{
		m_textFile = copy_ptr(elem.m_textFile);
		m_path = elem.m_path;
		m_name = elem.m_name;
	...
	@return 
	*/
	shared_ptr< _TextFile<EncodingT> > getTextFile() const 
	{
		return m_textFile;
	}
	...
	@param textFile 
	*/
	void setTextFile(shared_ptr< _TextFile<EncodingT> > textFile)  
	{
		m_textFile = copy_ptr(textFile);
	}
	...
	*/
	...
	@return 
	*/
	shared_ptr< _CppFileType<EncodingT> > getCppFileType() const 
	{
	...
	@param cppFileType 
	*/
	void setCppFileType(shared_ptr< _CppFileType<EncodingT> > cppFileType)  
	{
	...
	*/
	shared_ptr< _CppFunction<EncodingT> >& getCppDeclarationFunctionAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFunction<EncodingT> > getCppDeclarationFunctionAt(size_t n) const 
	{
		return m_cppDeclarationFunctions.at(n);
	}
	...
	*/
	void addCppDeclarationFunction(shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	*/
	CppDeclarationFunctionIterator insertCppDeclarationFunction(CppDeclarationFunctionIterator pos, shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppDeclarationFunctions, pos), static_cast< shared_ptr< _CppFunction<EncodingT> >(*)(shared_ptr< _CppFunction<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFunction<EncodingT> >& getCppDefinitionFunctionAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppFunction<EncodingT> > getCppDefinitionFunctionAt(size_t n) const 
	{
		return m_cppDefinitionFunctions.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppDefinitionFunction(shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppDefinitionFunctionIterator insertCppDefinitionFunction(CppDefinitionFunctionIterator pos, shared_ptr< _CppFunction<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppDefinitionFunctions, pos), static_cast< shared_ptr< _CppFunction<EncodingT> >(*)(shared_ptr< _CppFunction<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppInclude<EncodingT> >& getCppIncludeAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppInclude<EncodingT> > getCppIncludeAt(size_t n) const 
	{
		return m_cppIncludes.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppInclude(shared_ptr< _CppInclude<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppIncludeIterator insertCppInclude(CppIncludeIterator pos, shared_ptr< _CppInclude<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppIncludes, pos), static_cast< shared_ptr< _CppInclude<EncodingT> >(*)(shared_ptr< _CppInclude<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppClass<EncodingT> >& getCppClassAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppClass<EncodingT> > getCppClassAt(size_t n) const 
	{
		return m_cppClasss.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppClass(shared_ptr< _CppClass<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppClassIterator insertCppClass(CppClassIterator pos, shared_ptr< _CppClass<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppClasss, pos), static_cast< shared_ptr< _CppClass<EncodingT> >(*)(shared_ptr< _CppClass<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppEnum<EncodingT> >& getCppEnumAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CppEnum<EncodingT> > getCppEnumAt(size_t n) const 
	{
		return m_cppEnums.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCppEnum(shared_ptr< _CppEnum<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CppEnumIterator insertCppEnum(CppEnumIterator pos, shared_ptr< _CppEnum<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cppEnums, pos), static_cast< shared_ptr< _CppEnum<EncodingT> >(*)(shared_ptr< _CppEnum<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CMacro<EncodingT> >& getCMacroAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _CMacro<EncodingT> > getCMacroAt(size_t n) const 
	{
		return m_cMacros.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addCMacro(shared_ptr< _CMacro<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	CMacroIterator insertCMacro(CMacroIterator pos, shared_ptr< _CMacro<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_cMacros, pos), static_cast< shared_ptr< _CMacro<EncodingT> >(*)(shared_ptr< _CMacro<EncodingT> >) >(copy_ptr));
	}
	...
	*/
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _DebugFileInfo<EncodingT> >& getDebugFileInfoAt(size_t n)  
	{
	...
	@return The element at the specified position in the vector.
	*/
	shared_ptr< _DebugFileInfo<EncodingT> > getDebugFileInfoAt(size_t n) const 
	{
		return m_debugFileInfos.at(n);
	}
	...
	*/
	...
	@param o Value to be copied to the new element.
	*/
	void addDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o)  
	{
	...
	@return An iterator that points to the newly inserted element.
	*/
	DebugFileInfoIterator insertDebugFileInfo(DebugFileInfoIterator pos, shared_ptr< _DebugFileInfo<EncodingT> > o)  
	{
	...
	*/
	...
	{
		std::transform(first, last, std::inserter(m_debugFileInfos, pos), static_cast< shared_ptr< _DebugFileInfo<EncodingT> >(*)(shared_ptr< _DebugFileInfo<EncodingT> >) >(copy_ptr));
	}
