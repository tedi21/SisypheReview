...
public :
	...
	@param identifier 
	*/
	CppFileTypeIDEquality(int identifier)
	...
	bool operator()(shared_ptr< _CppFileType<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppFileType<EncodingT> > elem1, shared_ptr< _CppFileType<EncodingT> > elem2) const 
	{
