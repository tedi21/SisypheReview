...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppFileType<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppFileType<EncodingT>::CppFileTypeIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppFileType<EncodingT> >& elem1, const boost::shared_ptr< _CppFileType<EncodingT> >& elem2) const 
	{
