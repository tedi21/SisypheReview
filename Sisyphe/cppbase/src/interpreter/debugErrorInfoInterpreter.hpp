...
public:
	...
	FACTORY_BEGIN_REGISTER
		CLASS_KEY_REGISTER ( DebugErrorInfoInterpreter, UCS("DebugErrorInfo") );
		CLASS_KEY_REGISTER1( DebugErrorInfoInterpreter, UCS("DebugErrorInfo") );
		METHOD_KEY_REGISTER ( DebugErrorInfoInterpreter, boost::shared_ptr< Base<EncodingT> >, getIdentifier, const_t, UCS("DebugErrorInfo::Identifier") );
		METHOD_KEY_REGISTER ( DebugErrorInfoInterpreter, boost::shared_ptr< Base<EncodingT> >, getCallStack, const_t, UCS("DebugErrorInfo::CallStack") );
		METHOD_KEY_REGISTER1( DebugErrorInfoInterpreter, void, setCallStack, no_const_t, UCS("DebugErrorInfo::CallStack") );
	FACTORY_END_REGISTER

	FACTORY_BEGIN_UNREGISTER
		CLASS_KEY_UNREGISTER ( UCS("DebugErrorInfo") );
		CLASS_KEY_UNREGISTER1( UCS("DebugErrorInfo") );
		METHOD_KEY_UNREGISTER ( UCS("DebugErrorInfo::Identifier") );
		METHOD_KEY_UNREGISTER ( UCS("DebugErrorInfo::CallStack") );
		METHOD_KEY_UNREGISTER1( UCS("DebugErrorInfo::CallStack") );
