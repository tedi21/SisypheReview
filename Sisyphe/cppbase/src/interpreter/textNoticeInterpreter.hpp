...
{
private:
	shared_ptr< _TextNotice<EncodingT> > m_value;

public:
	TextNoticeInterpreter();

	TextNoticeInterpreter(shared_ptr< _TextNotice<EncodingT> > const& value);
	...
	FACTORY_PROTOTYPE5(TextNoticeInterpreter,
				...
				In< shared_ptr< Base<EncodingT> > >,
				In< shared_ptr< Base<EncodingT> > >)
	TextNoticeInterpreter(shared_ptr< Base<EncodingT> > const& description,
	...
	shared_ptr< _TextNotice<EncodingT> > getValue() const;

	void setValue(shared_ptr< _TextNotice<EncodingT> > const& value);
	...
	shared_ptr< Base<EncodingT> > getDescription() const;
	...
	FACTORY_PROTOTYPE1(setDescription, In< shared_ptr< Base<EncodingT> > >)
	void setDescription(shared_ptr< Base<EncodingT> > const& description);
	...
	FACTORY_BEGIN_REGISTER
		...
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getRowid, const_t, C("TextNotice::Rowid") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getDescription, const_t, C("TextNotice::Description") );
		METHOD_KEY_REGISTER1( TextNoticeInterpreter, void, setDescription, no_const_t, C("TextNotice::Description") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getCategory, const_t, C("TextNotice::Category") );
		METHOD_KEY_REGISTER1( TextNoticeInterpreter, void, setCategory, no_const_t, C("TextNotice::Category") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getLineNumber, const_t, C("TextNotice::LineNumber") );
		...
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getTextFile, no_const_t, C("TextNotice::TextFile") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, hasTextFile, const_t, C("TextNotice::HasTextFile") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, void, removeTextFile, no_const_t, C("TextNotice::removeTextFile") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getStartBlock, const_t, C("TextNotice::StartBlock") );
		METHOD_KEY_REGISTER1( TextNoticeInterpreter, void, setStartBlock, no_const_t, C("TextNotice::StartBlock") );
		METHOD_KEY_REGISTER ( TextNoticeInterpreter, shared_ptr< Base<EncodingT> >, getLengthBlock, const_t, C("TextNotice::LengthBlock") );
