...
public:
	...
	FACTORY_BEGIN_REGISTER
		...
		CLASS_KEY_REGISTER5( CppEnumConstantInterpreter, C("CppEnumConstant") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getIdentifier, const_t, C("CppEnumConstant::Identifier") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getName, const_t, C("CppEnumConstant::Name") );
		METHOD_KEY_REGISTER1( CppEnumConstantInterpreter, void, setName, no_const_t, C("CppEnumConstant::Name") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getDefaultValue, const_t, C("CppEnumConstant::DefaultValue") );
		...
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getCppEnum, no_const_t, C("CppEnumConstant::CppEnum") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, hasCppEnum, const_t, C("CppEnumConstant::HasCppEnum") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, void, removeCppEnum, no_const_t, C("CppEnumConstant::removeCppEnum") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getLineNumber, const_t, C("CppEnumConstant::LineNumber") );
		METHOD_KEY_REGISTER1( CppEnumConstantInterpreter, void, setLineNumber, no_const_t, C("CppEnumConstant::LineNumber") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getStartBlock, const_t, C("CppEnumConstant::StartBlock") );
		METHOD_KEY_REGISTER1( CppEnumConstantInterpreter, void, setStartBlock, no_const_t, C("CppEnumConstant::StartBlock") );
		METHOD_KEY_REGISTER ( CppEnumConstantInterpreter, boost::shared_ptr< Base<EncodingT> >, getLengthBlock, const_t, C("CppEnumConstant::LengthBlock") );
	...
	FACTORY_BEGIN_UNREGISTER
		...
		CLASS_KEY_UNREGISTER5( C("CppEnumConstant") );
		...
		METHOD_KEY_UNREGISTER ( C("CppEnumConstant::LineNumber") );
		METHOD_KEY_UNREGISTER1( C("CppEnumConstant::LineNumber") );
