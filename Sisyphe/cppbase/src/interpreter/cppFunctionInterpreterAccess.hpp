...
public:
	...
	void fillAllDebugFunctionInfos(boost::shared_ptr< Base<EncodingT> >& cppFunction, const boost::shared_ptr< Base<EncodingT> >& nowait);

	FACTORY_PROTOTYPE3(fillOneDebugFunctionInfo,
				InOut< boost::shared_ptr< Base<EncodingT> > >,
				In< boost::shared_ptr< Base<EncodingT> > >,
				In< boost::shared_ptr< Base<EncodingT> > >)
	void fillOneDebugFunctionInfo(boost::shared_ptr< Base<EncodingT> >& refCppFunction,
				const boost::shared_ptr< Base<EncodingT> >& identifier,
				const boost::shared_ptr< Base<EncodingT> >& nowait);
	...
	void fillManyDebugFunctionInfos(boost::shared_ptr< Base<EncodingT> >& cppFunction, const boost::shared_ptr< Base<EncodingT> >& filter, const boost::shared_ptr< Base<EncodingT> >& nowait);
