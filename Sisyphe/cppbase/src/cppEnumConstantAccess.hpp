...
private :
	using backup_t = std::set< boost::shared_ptr< _CppEnumConstant<EncodingT> >, typename _CppEnumConstant<EncodingT>::CppEnumConstantIDInferior >;
	backup_t m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _CppEnumConstant<EncodingT> > getOneCppEnumConstant(long long identifier) const;
	...
	*/
	...
	@return The CppEnumConstant object.
	*/
	 boost::shared_ptr< _CppEnumConstant<EncodingT> > selectOneCppEnumConstant(long long identifier, bool nowait = false, bool addition = false);
