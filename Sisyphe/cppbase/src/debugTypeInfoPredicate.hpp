...
public :
	...
	*/
	...
	bool operator()(boost::shared_ptr< _DebugTypeInfo<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(boost::shared_ptr< _DebugTypeInfo<EncodingT> > elem1, boost::shared_ptr< _DebugTypeInfo<EncodingT> > elem2) const 
	{
