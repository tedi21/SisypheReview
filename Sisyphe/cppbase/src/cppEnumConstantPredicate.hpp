...
public :
	...
	*/
	...
	bool operator()(shared_ptr< _CppEnumConstant<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppEnumConstant<EncodingT> > elem1, shared_ptr< _CppEnumConstant<EncodingT> > elem2) const 
	{
