...
public :
	...
	*/
	...
	bool operator()(shared_ptr< _CppParameter<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppParameter<EncodingT> > elem1, shared_ptr< _CppParameter<EncodingT> > elem2) const 
	{
