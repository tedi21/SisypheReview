...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppParameter<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppParameter<EncodingT>::CppParameterIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppParameter<EncodingT> >& elem1, const boost::shared_ptr< _CppParameter<EncodingT> >& elem2) const 
	{
