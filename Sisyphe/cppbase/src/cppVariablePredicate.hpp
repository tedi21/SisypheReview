...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppVariable<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppVariable<EncodingT>::CppVariableIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppVariable<EncodingT> >& elem1, const boost::shared_ptr< _CppVariable<EncodingT> >& elem2) const 
	{
