...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CppAttribute<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CppAttribute<EncodingT>::CppAttributeIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CppAttribute<EncodingT> >& elem1, const boost::shared_ptr< _CppAttribute<EncodingT> >& elem2) const 
	{
