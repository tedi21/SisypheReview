...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _DebugValueInfo<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _DebugValueInfo<EncodingT>::DebugValueInfoIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _DebugValueInfo<EncodingT> >& elem1, const boost::shared_ptr< _DebugValueInfo<EncodingT> >& elem2) const 
	{
