...
public :
	...
	*/
	...
	bool operator()(boost::shared_ptr< _Rule<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(boost::shared_ptr< _Rule<EncodingT> > elem1, boost::shared_ptr< _Rule<EncodingT> > elem2) const 
	{
