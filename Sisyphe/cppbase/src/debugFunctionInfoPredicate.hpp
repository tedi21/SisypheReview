...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _DebugFunctionInfo<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _DebugFunctionInfo<EncodingT>::DebugFunctionInfoIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _DebugFunctionInfo<EncodingT> >& elem1, const boost::shared_ptr< _DebugFunctionInfo<EncodingT> >& elem2) const 
	{
