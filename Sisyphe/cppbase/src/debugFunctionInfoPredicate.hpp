...
public :
	...
	*/
	...
	bool operator()(shared_ptr< _DebugFunctionInfo<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _DebugFunctionInfo<EncodingT> > elem1, shared_ptr< _DebugFunctionInfo<EncodingT> > elem2) const 
	{
