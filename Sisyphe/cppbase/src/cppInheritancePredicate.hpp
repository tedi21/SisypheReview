...
public :
	...
	@param identifier 
	*/
	CppInheritanceIDEquality(int identifier)
	...
	bool operator()(shared_ptr< _CppInheritance<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CppInheritance<EncodingT> > elem1, shared_ptr< _CppInheritance<EncodingT> > elem2) const 
	{
