...
public :
	...
	*/
	...
	bool operator()(const boost::shared_ptr< _CMacro<EncodingT> >& other) const 
	{
...
template<class EncodingT>
class  _CMacro<EncodingT>::CMacroIDInferior {
private :
public :
	bool operator()(const boost::shared_ptr< _CMacro<EncodingT> >& elem1, const boost::shared_ptr< _CMacro<EncodingT> >& elem2) const 
	{
