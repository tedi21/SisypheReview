...
public :
	...
	@param identifier 
	*/
	CMacroIDEquality(int identifier)
	...
	bool operator()(shared_ptr< _CMacro<EncodingT> > other) const 
	{
...
private :
public :
	bool operator()(shared_ptr< _CMacro<EncodingT> > elem1, shared_ptr< _CMacro<EncodingT> > elem2) const 
	{
