...
private :
	std::vector< shared_ptr< _CppEnum<EncodingT> > > m_backup;
...
public :
	...
	*/
	 std::vector< shared_ptr< _CppEnum<EncodingT> > > getManyCppEnums(typename EncodingT::string_t const&  filter) const;
	/** Returns all CppEnum objects from database.
	@return List of CppEnum objects.
	*/
	 std::vector< shared_ptr< _CppEnum<EncodingT> > > getAllCppEnums() const;
	/** Returns CppEnum object from database.
	@param identifier 
	@return The CppEnum object.
	*/
	 shared_ptr< _CppEnum<EncodingT> > getOneCppEnum(int identifier) const;
	/** Returns CppEnum objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of CppEnum objects.
	*/
	 std::vector< shared_ptr< _CppEnum<EncodingT> > > selectManyCppEnums(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns CppEnum object from database. Data are locked for update.
	@param identifier 
	@param nowait Asynchonous call.
	@return The CppEnum object.
	*/
	 shared_ptr< _CppEnum<EncodingT> > selectOneCppEnum(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedCppEnum(shared_ptr< _CppEnum<EncodingT> > o) const;
	...
	*/
	...
	@param o The CppEnum object.
	*/
	 void fillCppFile(shared_ptr< _CppEnum<EncodingT> > o);
	/** Fills cppEnumConstant data from database.
	@param o The CppEnum object.
	@param nowait Asynchronous call.
	*/
	 void fillAllCppEnumConstants(shared_ptr< _CppEnum<EncodingT> > o, bool nowait = false);
	/** Fills cppEnumConstant data from database.
	@param o The CppEnum object.
	@param identifier 
	@param nowait Asynchronous call.
	*/
	 void fillOneCppEnumConstant(shared_ptr< _CppEnum<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppEnumConstant data from database.
	@param o The CppEnum object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	*/
	 void fillManyCppEnumConstants(shared_ptr< _CppEnum<EncodingT> > o, typename EncodingT::string_t const&  filter, bool nowait = false);
	/** Returns whether CppEnum data are altered from database.
	@param o The CppEnum object.
	@return True if data CppEnum have been altered.
	*/
	 bool isModifiedCppEnum(shared_ptr< _CppEnum<EncodingT> > o) const;
	/** Updates CppEnum data to database.
	@param o The CppEnum object.
	*/
	 void updateCppEnum(shared_ptr< _CppEnum<EncodingT> > o);
	/** Inserts CppEnum data to database.
	@param o The CppEnum object.
	*/
	 void insertCppEnum(shared_ptr< _CppEnum<EncodingT> > o);
	/** Deletes CppEnum data to database.
	@param o The CppEnum object.
	*/
	 void deleteCppEnum(shared_ptr< _CppEnum<EncodingT> > o);
