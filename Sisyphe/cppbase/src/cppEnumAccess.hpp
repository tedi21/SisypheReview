...
private :
	std::vector< boost::shared_ptr< _CppEnum<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _CppEnum<EncodingT> > getOneCppEnum(int identifier) const;
	...
	*/
	...
	@return The CppEnum object.
	*/
	 boost::shared_ptr< _CppEnum<EncodingT> > selectOneCppEnum(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	...
	@param nowait Asynchronous call.
	*/
	 void fillOneCppEnumConstant(boost::shared_ptr< _CppEnum<EncodingT> > o, int identifier, bool nowait = false);
	/** Fills cppEnumConstant data from database.
	@param o The CppEnum object.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
