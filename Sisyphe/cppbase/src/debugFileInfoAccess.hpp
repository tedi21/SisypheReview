...
private :
	std::vector< shared_ptr< _DebugFileInfo<EncodingT> > > m_backup;
...
public :
	...
	*/
	 std::vector< shared_ptr< _DebugFileInfo<EncodingT> > > getManyDebugFileInfos(typename EncodingT::string_t const&  filter) const;
	/** Returns all DebugFileInfo objects from database.
	@return List of DebugFileInfo objects.
	*/
	 std::vector< shared_ptr< _DebugFileInfo<EncodingT> > > getAllDebugFileInfos() const;
	/** Returns DebugFileInfo object from database.
	@param identifier 
	@return The DebugFileInfo object.
	*/
	 shared_ptr< _DebugFileInfo<EncodingT> > getOneDebugFileInfo(int identifier) const;
	/** Returns DebugFileInfo objects from database. Data are locked for update.
	@param filter Condition allowing to filter data.
	@param nowait Asynchonous call.
	@return List of DebugFileInfo objects.
	*/
	 std::vector< shared_ptr< _DebugFileInfo<EncodingT> > > selectManyDebugFileInfos(typename EncodingT::string_t const&  filter, bool nowait = false, bool addition = false);
	/** Returns DebugFileInfo object from database. Data are locked for update.
	@param identifier 
	@param nowait Asynchonous call.
	@return The DebugFileInfo object.
	*/
	 shared_ptr< _DebugFileInfo<EncodingT> > selectOneDebugFileInfo(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	 bool isSelectedDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o) const;
	...
	*/
	...
	@param o The DebugFileInfo object.
	*/
	 void fillCppFile(shared_ptr< _DebugFileInfo<EncodingT> > o);
	/** Returns whether DebugFileInfo data are altered from database.
	@param o The DebugFileInfo object.
	@return True if data DebugFileInfo have been altered.
	*/
	 bool isModifiedDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o) const;
	/** Updates DebugFileInfo data to database.
	@param o The DebugFileInfo object.
	*/
	 void updateDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o);
	/** Inserts DebugFileInfo data to database.
	@param o The DebugFileInfo object.
	*/
	 void insertDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o);
	/** Deletes DebugFileInfo data to database.
	@param o The DebugFileInfo object.
	*/
	 void deleteDebugFileInfo(shared_ptr< _DebugFileInfo<EncodingT> > o);
