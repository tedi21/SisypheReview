...
private :
	std::vector< boost::shared_ptr< _DebugFileInfo<EncodingT> > > m_backup;
...
public :
	...
	*/
	 boost::shared_ptr< _DebugFileInfo<EncodingT> > getOneDebugFileInfo(int identifier) const;
	...
	*/
	...
	@return The DebugFileInfo object.
	*/
	 boost::shared_ptr< _DebugFileInfo<EncodingT> > selectOneDebugFileInfo(int identifier, bool nowait = false, bool addition = false);
	...
	*/
	...
	@param o The DebugFileInfo object.
	*/
	 void fillCppFile(boost::shared_ptr< _DebugFileInfo<EncodingT> > o);
