...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_PROTOTYPE1(loadDataFromPdb, In< shared_ptr< Base<EncodingT> > >)
		shared_ptr< Base<EncodingT> > loadDataFromPdb(const shared_ptr< Base<EncodingT> >& pdbPath);

		// Ouvre une session pour obtenir des symboles.
		FACTORY_PROTOTYPE1(openSession, InOut< shared_ptr< Base<EncodingT> > >)
		shared_ptr< Base<EncodingT> > openSession(shared_ptr< Base<EncodingT> >& ppSession);

		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDiaDataSourcePtrInterpreter, C("IDiaDataSourcePtr") );
			METHOD_KEY_REGISTER1( IDiaDataSourcePtrInterpreter, shared_ptr< Base<EncodingT> >, loadDataFromPdb, no_const_t, C("IDiaDataSourcePtr::LoadDataFromPdb") );
			METHOD_KEY_REGISTER1( IDiaDataSourcePtrInterpreter, shared_ptr< Base<EncodingT> >, openSession, no_const_t, C("IDiaDataSourcePtr::OpenSession") );
