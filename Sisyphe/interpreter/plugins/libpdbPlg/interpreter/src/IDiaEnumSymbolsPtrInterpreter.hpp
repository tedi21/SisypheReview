...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER1( IDiaEnumSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_Count, no_const_t, C("IDiaEnumSymbolsPtr::Get_Count") );
			METHOD_KEY_REGISTER2( IDiaEnumSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, item, no_const_t, C("IDiaEnumSymbolsPtr::Item") );
			METHOD_KEY_REGISTER3( IDiaEnumSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, next, no_const_t, C("IDiaEnumSymbolsPtr::Next") );
			METHOD_KEY_REGISTER1( IDiaEnumSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, skip, no_const_t, C("IDiaEnumSymbolsPtr::Skip") );
			METHOD_KEY_REGISTER ( IDiaEnumSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, reset, no_const_t, C("IDiaEnumSymbolsPtr::Reset") );
