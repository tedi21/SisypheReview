...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER1( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getSymbolsByAddr, no_const_t, C("IDiaSessionPtr::GetSymbolsByAddr") );
			METHOD_KEY_REGISTER1( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getEnumTables, no_const_t, C("IDiaSessionPtr::GetEnumTables") );
			METHOD_KEY_REGISTER4( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, findSymbolByAddr, no_const_t, C("IDiaSessionPtr::FindSymbolByAddr") );
			METHOD_KEY_REGISTER3( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, findSymbolByRVA, no_const_t, C("IDiaSessionPtr::FindSymbolByRVA") );
			METHOD_KEY_REGISTER2( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, symbolById, no_const_t, C("IDiaSessionPtr::SymbolById") );
			METHOD_KEY_REGISTER2( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, symsAreEquiv, no_const_t, C("IDiaSessionPtr::SymsAreEquiv") );
			...
			METHOD_KEY_REGISTER4( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, findLinesByAddr, no_const_t, C("IDiaSessionPtr::FindLinesByAddr") );
			...
			METHOD_KEY_REGISTER5( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, findChildren, no_const_t, C("IDiaSessionPtr::FindChildren") );
			METHOD_KEY_REGISTER3( IDiaSessionPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, findChildren, no_const_t, C("IDiaSessionPtr::FindChildren") );
		...
		FACTORY_BEGIN_UNREGISTER
			...
			METHOD_KEY_UNREGISTER1( C("IDiaSessionPtr::GetSymbolsByAddr") );
			METHOD_KEY_UNREGISTER1( C("IDiaSessionPtr::GetEnumTables") );
			METHOD_KEY_UNREGISTER4( C("IDiaSessionPtr::FindSymbolByAddr") );
			METHOD_KEY_UNREGISTER3( C("IDiaSessionPtr::FindSymbolByRVA") );
			METHOD_KEY_UNREGISTER2( C("IDiaSessionPtr::SymbolById") );
			METHOD_KEY_UNREGISTER2( C("IDiaSessionPtr::SymsAreEquiv") );
			METHOD_KEY_UNREGISTER3( C("IDiaSessionPtr::FindLinesByRVA") );
			METHOD_KEY_UNREGISTER4( C("IDiaSessionPtr::FindLinesByAddr") );
			...
			METHOD_KEY_UNREGISTER5( C("IDiaSessionPtr::FindChildren") );
			METHOD_KEY_UNREGISTER3( C("IDiaSessionPtr::FindChildren") );
