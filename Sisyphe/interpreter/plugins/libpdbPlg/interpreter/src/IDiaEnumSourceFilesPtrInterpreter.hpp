...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDiaEnumSourceFilesPtrInterpreter, UCS("IDiaEnumSourceFilesPtr") );
			METHOD_KEY_REGISTER1( IDiaEnumSourceFilesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_Count, no_const_t, UCS("IDiaEnumSourceFilesPtr::Get_Count") );
			METHOD_KEY_REGISTER2( IDiaEnumSourceFilesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, item, no_const_t, UCS("IDiaEnumSourceFilesPtr::Item") );
			METHOD_KEY_REGISTER3( IDiaEnumSourceFilesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, next, no_const_t, UCS("IDiaEnumSourceFilesPtr::Next") );
			METHOD_KEY_REGISTER1( IDiaEnumSourceFilesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, skip, no_const_t, UCS("IDiaEnumSourceFilesPtr::Skip") );
			METHOD_KEY_REGISTER ( IDiaEnumSourceFilesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, reset, no_const_t, UCS("IDiaEnumSourceFilesPtr::Reset") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("IDiaEnumSourceFilesPtr") );
			METHOD_KEY_UNREGISTER1( UCS("IDiaEnumSourceFilesPtr::Get_Count") );
			METHOD_KEY_UNREGISTER2( UCS("IDiaEnumSourceFilesPtr::Item") );
			METHOD_KEY_UNREGISTER3( UCS("IDiaEnumSourceFilesPtr::Next") );
			METHOD_KEY_UNREGISTER1( UCS("IDiaEnumSourceFilesPtr::Skip") );
			METHOD_KEY_UNREGISTER ( UCS("IDiaEnumSourceFilesPtr::Reset") );
