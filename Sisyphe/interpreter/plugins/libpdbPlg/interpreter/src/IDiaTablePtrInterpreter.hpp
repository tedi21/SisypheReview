...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDiaTablePtrInterpreter, UCS("IDiaTablePtr") );
			METHOD_KEY_REGISTER1( IDiaTablePtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_name, no_const_t, UCS("IDiaTablePtr::Get_name") );
			METHOD_KEY_REGISTER1( IDiaTablePtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_Count, no_const_t, UCS("IDiaTablePtr::Get_Count") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("IDiaTablePtr") );
			METHOD_KEY_UNREGISTER1( UCS("IDiaTablePtr::Get_name") );
			METHOD_KEY_UNREGISTER1( UCS("IDiaTablePtr::Get_Count") );
