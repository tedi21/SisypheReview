...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		IDiaEnumTablesPtrInterpreter(const IDiaEnumTablesPtrInterpreter<EncodingT>& rhs);

		IDiaEnumTablesPtrInterpreter<EncodingT>& operator=(const IDiaEnumTablesPtrInterpreter<EncodingT>& rhs);
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDiaEnumTablesPtrInterpreter, C("IDiaEnumTablesPtr") );
			METHOD_KEY_REGISTER1( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_Count, no_const_t, C("IDiaEnumTablesPtr::Get_Count") );
			METHOD_KEY_REGISTER2( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, itemByIndex, no_const_t, C("IDiaEnumTablesPtr::ItemByIndex") );
			METHOD_KEY_REGISTER2( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, itemByName, no_const_t, C("IDiaEnumTablesPtr::ItemByName") );
			METHOD_KEY_REGISTER3( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, next, no_const_t, C("IDiaEnumTablesPtr::Next") );
			METHOD_KEY_REGISTER1( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, skip, no_const_t, C("IDiaEnumTablesPtr::Skip") );
			METHOD_KEY_REGISTER ( IDiaEnumTablesPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, reset, no_const_t, C("IDiaEnumTablesPtr::Reset") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( C("IDiaEnumTablesPtr") );
			METHOD_KEY_UNREGISTER1( C("IDiaEnumTablesPtr::Get_Count") );
			METHOD_KEY_UNREGISTER2( C("IDiaEnumTablesPtr::ItemByIndex") );
			METHOD_KEY_UNREGISTER2( C("IDiaEnumTablesPtr::ItemByName") );
			METHOD_KEY_UNREGISTER3( C("IDiaEnumTablesPtr::Next") );
			METHOD_KEY_UNREGISTER1( C("IDiaEnumTablesPtr::Skip") );
			METHOD_KEY_UNREGISTER ( C("IDiaEnumTablesPtr::Reset") );
