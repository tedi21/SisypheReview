...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaDataSourcePtrInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new IDiaDataSourcePtrInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaDataSourcePtrInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaDataSourcePtrInterpreter<EncodingT>::loadDataFromPdb(const shared_ptr< Base<EncodingT> >& pdbPath)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaDataSourcePtrInterpreter<EncodingT>::openSession(shared_ptr< Base<EncodingT> >& ppSession)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
template <class EncodingT>
bool check_IDiaDataSourcePtr(shared_ptr< Base<EncodingT> > const& val, IDiaDataSourcePtr& a)
{
	shared_ptr< IDiaDataSourcePtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDiaDataSourcePtrInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
...
template <class EncodingT>
bool reset_IDiaDataSourcePtr(shared_ptr< Base<EncodingT> >& val, IDiaDataSourcePtr const& a)
{
	shared_ptr< IDiaDataSourcePtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDiaDataSourcePtrInterpreter<EncodingT> >(val);
	if (value)
	{
