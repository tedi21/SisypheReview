...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_lineNumber, no_const_t, C("IDiaLineNumberPtr::Get_lineNumber") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_lineNumberEnd, no_const_t, C("IDiaLineNumberPtr::Get_lineNumberEnd") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_columnNumber, no_const_t, C("IDiaLineNumberPtr::Get_columnNumber") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_columnNumberEnd, no_const_t, C("IDiaLineNumberPtr::Get_columnNumberEnd") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_length, no_const_t, C("IDiaLineNumberPtr::Get_length") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_statement, no_const_t, C("IDiaLineNumberPtr::Get_statement") );
			METHOD_KEY_REGISTER1( IDiaLineNumberPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, get_sourceFile, no_const_t, C("IDiaLineNumberPtr::Get_sourceFile") );
