...
public:
  ...
  boost::shared_ptr< Base<EncodingT> > getDataSource() const;
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER ( PdbParserInterpreter, boost::shared_ptr< Base<EncodingT> >, initialize, const_t, C("PdbParser::Initialize") );
			METHOD_KEY_REGISTER ( PdbParserInterpreter, boost::shared_ptr< Base<EncodingT> >, terminate, const_t, C("PdbParser::Terminate") );
