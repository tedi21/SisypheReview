...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( WordMacroInterpreter, UCS("WordMacro") );
			METHOD_KEY_REGISTER3( WordMacroInterpreter, boost::shared_ptr< Base<EncodingT> >, convertToXML, const_t, UCS("WordMacro::ConvertToXML") );
			METHOD_KEY_REGISTER3( WordMacroInterpreter, boost::shared_ptr< Base<EncodingT> >, convertToDOC, const_t, UCS("WordMacro::ConvertToDOC") );
			METHOD_KEY_REGISTER3( WordMacroInterpreter, boost::shared_ptr< Base<EncodingT> >, convertToPDF, const_t, UCS("WordMacro::ConvertToPDF") );
			METHOD_KEY_REGISTER3( WordMacroInterpreter, boost::shared_ptr< Base<EncodingT> >, convertToXDOC, const_t, UCS("WordMacro::ConvertToXDOC") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("WordMacro") );
			METHOD_KEY_UNREGISTER3( UCS("WordMacro::ConvertToXML") );
			METHOD_KEY_UNREGISTER3( UCS("WordMacro::ConvertToDOC") );
			METHOD_KEY_UNREGISTER3( UCS("WordMacro::ConvertToPDF") );
			METHOD_KEY_UNREGISTER3( UCS("WordMacro::ConvertToXDOC") );
