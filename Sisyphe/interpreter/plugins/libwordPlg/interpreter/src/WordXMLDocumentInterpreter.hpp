...
WordXMLDocument* m_object;  
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER1( WordXMLDocumentInterpreter, boost::shared_ptr< Base<EncodingT> >, createNode, no_const_t, C("WordXMLDocument::CreateNode") );
			METHOD_KEY_REGISTER1( WordXMLDocumentInterpreter, boost::shared_ptr< Base<EncodingT> >, createTextNode, no_const_t, C("WordXMLDocument::CreateTextNode") );
			METHOD_KEY_REGISTER ( WordXMLDocumentInterpreter, boost::shared_ptr< Base<EncodingT> >, getDocumentNode, no_const_t, C("WordXMLDocument::DocumentNode") );
