...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( WordXMLNodeListInterpreter, UCS("WordXMLNodeList") );
			METHOD_KEY_REGISTER1( WordXMLNodeListInterpreter, boost::shared_ptr< Base<EncodingT> >, item, const_t, UCS("WordXMLNodeList::Item") );
			METHOD_KEY_REGISTER ( WordXMLNodeListInterpreter, boost::shared_ptr< Base<EncodingT> >, length, const_t, UCS("WordXMLNodeList::Length") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("WordXMLNodeList") );
			METHOD_KEY_UNREGISTER1( UCS("WordXMLNodeList::Item") );
			METHOD_KEY_UNREGISTER ( UCS("WordXMLNodeList::Length") );
