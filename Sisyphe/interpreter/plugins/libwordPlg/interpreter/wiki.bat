...
refactor.exe -UTF8 ..\interpreter\plugins\libwordPlg\interpreter\WordXML.sidl -to MD -import ..\interpreter\plugins\libwordPlg\interpreter\interpreter.wordxml.xml -dir ..\script\plugins\libwordPlg\interpreter\wiki\ -v 5
pause