...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_INT8, const_t, C("DebugValue::DEBUG_VALUE_INT8") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_INT16, const_t, C("DebugValue::DEBUG_VALUE_INT16") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_INT32, const_t, C("DebugValue::DEBUG_VALUE_INT32") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_INT64, const_t, C("DebugValue::DEBUG_VALUE_INT64") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_FLOAT32, const_t, C("DebugValue::DEBUG_VALUE_FLOAT32") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_FLOAT64, const_t, C("DebugValue::DEBUG_VALUE_FLOAT64") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_FLOAT80, const_t, C("DebugValue::DEBUG_VALUE_FLOAT80") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_FLOAT82, const_t, C("DebugValue::DEBUG_VALUE_FLOAT82") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_FLOAT128, const_t, C("DebugValue::DEBUG_VALUE_FLOAT128") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_VECTOR64, const_t, C("DebugValue::DEBUG_VALUE_VECTOR64") );
			METHOD_KEY_REGISTER ( DebugValueInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_VALUE_VECTOR128, const_t, C("DebugValue::DEBUG_VALUE_VECTOR128") );
