...
template <class EncodingT>
shared_ptr< Base<EncodingT> > TimeOutInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new TimeOutInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > TimeOutInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > TimeOutInterpreter<EncodingT>::getINFINITE() const
{
	return shared_ptr< Base<EncodingT> > (new Numeric<EncodingT>(INFINITE));
}
