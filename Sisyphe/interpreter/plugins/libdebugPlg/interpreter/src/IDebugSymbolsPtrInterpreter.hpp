...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDebugSymbolsPtrInterpreter, UCS("IDebugSymbolsPtr") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, addSymbolOptions, no_const_t, UCS("IDebugSymbolsPtr::AddSymbolOptions") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, appendImagePath, no_const_t, UCS("IDebugSymbolsPtr::AppendImagePath") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, appendSourcePath, no_const_t, UCS("IDebugSymbolsPtr::AppendSourcePath") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, appendSymbolPath, no_const_t, UCS("IDebugSymbolsPtr::AppendSymbolPath") );
			METHOD_KEY_REGISTER2( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getSymbolModule, no_const_t, UCS("IDebugSymbolsPtr::GetSymbolModule") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getSymbolOptions, no_const_t, UCS("IDebugSymbolsPtr::GetSymbolOptions") );
			METHOD_KEY_REGISTER1( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getSymbolPath, no_const_t, UCS("IDebugSymbolsPtr::GetSymbolPath") );
			METHOD_KEY_REGISTER4( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getLineByOffset, no_const_t, UCS("IDebugSymbolsPtr::GetLineByOffset") );
			METHOD_KEY_REGISTER4( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getModuleByOffset, no_const_t, UCS("IDebugSymbolsPtr::GetModuleByOffset") );
			METHOD_KEY_REGISTER3( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getNameByOffset, no_const_t, UCS("IDebugSymbolsPtr::GetNameByOffset") );
			METHOD_KEY_REGISTER4( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getNearNameByOffset, no_const_t, UCS("IDebugSymbolsPtr::GetNearNameByOffset") );
			METHOD_KEY_REGISTER3( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getOffsetByLine, no_const_t, UCS("IDebugSymbolsPtr::GetOffsetByLine") );
			METHOD_KEY_REGISTER2( IDebugSymbolsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getSourceFileLineOffsets, no_const_t, UCS("IDebugSymbolsPtr::GetSourceFileLineOffsets") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("IDebugSymbolsPtr") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::AddSymbolOptions") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::AppendImagePath") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::AppendSourcePath") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::AppendSymbolPath") );
			METHOD_KEY_UNREGISTER2( UCS("IDebugSymbolsPtr::GetSymbolModule") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::GetSymbolOptions") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSymbolsPtr::GetSymbolPath") );
			METHOD_KEY_UNREGISTER4( UCS("IDebugSymbolsPtr::GetLineByOffset") );
			METHOD_KEY_UNREGISTER4( UCS("IDebugSymbolsPtr::GetModuleByOffset") );
			METHOD_KEY_UNREGISTER3( UCS("IDebugSymbolsPtr::GetNameByOffset") );
			METHOD_KEY_UNREGISTER4( UCS("IDebugSymbolsPtr::GetNearNameByOffset") );
			METHOD_KEY_UNREGISTER3( UCS("IDebugSymbolsPtr::GetOffsetByLine") );
			METHOD_KEY_UNREGISTER2( UCS("IDebugSymbolsPtr::GetSourceFileLineOffsets") );
