...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugSystemObjectsPtrInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new IDebugSystemObjectsPtrInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugSystemObjectsPtrInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugSystemObjectsPtrInterpreter<EncodingT>::getCurrentProcessId(shared_ptr< Base<EncodingT> >& processId)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugSystemObjectsPtrInterpreter<EncodingT>::getCurrentProcessDataOffset(shared_ptr< Base<EncodingT> >& offset)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugSystemObjectsPtrInterpreter<EncodingT>::getCurrentProcessExecutableName(shared_ptr< Base<EncodingT> >& buffer)
{
shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
{
	shared_ptr< IDebugSystemObjectsPtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDebugSystemObjectsPtrInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
