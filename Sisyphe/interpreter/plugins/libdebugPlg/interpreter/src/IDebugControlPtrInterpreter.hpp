...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER ( IDebugControlPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, isPointer64Bit, no_const_t, C("IDebugControlPtr::IsPointer64Bit") );
			METHOD_KEY_REGISTER6( IDebugControlPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getStackTrace, no_const_t, C("IDebugControlPtr::GetStackTrace") );
			METHOD_KEY_REGISTER3( IDebugControlPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getNearInstruction, no_const_t, C("IDebugControlPtr::GetNearInstruction") );
		...
		FACTORY_BEGIN_UNREGISTER
			...
			METHOD_KEY_UNREGISTER ( C("IDebugControlPtr::IsPointer64Bit") );
			METHOD_KEY_UNREGISTER6( C("IDebugControlPtr::GetStackTrace") );
			METHOD_KEY_UNREGISTER3( C("IDebugControlPtr::GetNearInstruction") );
