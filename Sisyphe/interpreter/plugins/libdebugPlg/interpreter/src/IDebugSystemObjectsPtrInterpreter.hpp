...
NAMESPACE_BEGIN(interp)
	...
	private:
		...
		IDebugSystemObjectsPtr& refValue();

		const IDebugSystemObjectsPtr& refValue() const;
	...
	public:
		...
		void value(IDebugSystemObjectsPtr const& object);
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDebugSystemObjectsPtrInterpreter, UCS("IDebugSystemObjectsPtr") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getCurrentProcessId, no_const_t, UCS("IDebugSystemObjectsPtr::GetCurrentProcessId") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getCurrentProcessDataOffset, no_const_t, UCS("IDebugSystemObjectsPtr::GetCurrentProcessDataOffset") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getCurrentProcessExecutableName, no_const_t, UCS("IDebugSystemObjectsPtr::GetCurrentProcessExecutableName") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("IDebugSystemObjectsPtr") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSystemObjectsPtr::GetCurrentProcessId") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSystemObjectsPtr::GetCurrentProcessDataOffset") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugSystemObjectsPtr::GetCurrentProcessExecutableName") );
