...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugClientPtrInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new IDebugClientPtrInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugClientPtrInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugClientPtrInterpreter<EncodingT>::createProcess(const shared_ptr< Base<EncodingT> >& commandLine, const shared_ptr< Base<EncodingT> >& createFlags)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugClientPtrInterpreter<EncodingT>::getRunningProcessSystemIds(shared_ptr< Base<EncodingT> >& processId)
{
shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDebugClientPtrInterpreter<EncodingT>::getRunningProcessDescription(const shared_ptr< Base<EncodingT> >& systemId, const shared_ptr< Base<EncodingT> >& flags, shared_ptr< Base<EncodingT> >& exeName, shared_ptr< Base<EncodingT> >& description)
{
shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
{
	shared_ptr< IDebugClientPtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDebugClientPtrInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
