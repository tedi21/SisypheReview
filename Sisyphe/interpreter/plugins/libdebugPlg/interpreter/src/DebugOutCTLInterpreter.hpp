...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			...
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_THIS_CLIENT, const_t, C("DebugOutCTL::DEBUG_OUTCTL_THIS_CLIENT") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_ALL_CLIENTS, const_t, C("DebugOutCTL::DEBUG_OUTCTL_ALL_CLIENTS") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_ALL_OTHER_CLIENTS, const_t, C("DebugOutCTL::DEBUG_OUTCTL_ALL_OTHER_CLIENTS") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_IGNORE, const_t, C("DebugOutCTL::DEBUG_OUTCTL_IGNORE") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_LOG_ONLY, const_t, C("DebugOutCTL::DEBUG_OUTCTL_LOG_ONLY") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_SEND_MASK, const_t, C("DebugOutCTL::DEBUG_OUTCTL_SEND_MASK") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_NOT_LOGGED, const_t, C("DebugOutCTL::DEBUG_OUTCTL_NOT_LOGGED") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_OVERRIDE_MASK, const_t, C("DebugOutCTL::DEBUG_OUTCTL_OVERRIDE_MASK") );
			METHOD_KEY_REGISTER ( DebugOutCTLInterpreter, boost::shared_ptr< Base<EncodingT> >, getDEBUG_OUTCTL_AMBIENT, const_t, C("DebugOutCTL::DEBUG_OUTCTL_AMBIENT") );
