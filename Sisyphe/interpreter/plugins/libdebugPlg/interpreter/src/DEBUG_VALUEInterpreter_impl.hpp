...
{
	boost::shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>(value().F32));
	return res;
}
...
{
	boost::shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>(value().F64));
	return res;
}
...
{
	boost::shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>(value().Type));
	return res;
}
...
{
	boost::shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>(value().TailOfRawBytes));
	return res;
}
