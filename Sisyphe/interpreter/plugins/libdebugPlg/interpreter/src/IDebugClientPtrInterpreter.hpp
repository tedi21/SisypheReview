...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDebugClientPtrInterpreter, UCS("IDebugClientPtr") );
			METHOD_KEY_REGISTER2( IDebugClientPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, createProcess, no_const_t, UCS("IDebugClientPtr::CreateProcess") );
			METHOD_KEY_REGISTER3( IDebugClientPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, createProcess, no_const_t, UCS("IDebugClientPtr::CreateProcess") );
			METHOD_KEY_REGISTER1( IDebugClientPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getRunningProcessSystemIds, no_const_t, UCS("IDebugClientPtr::GetRunningProcessSystemIds") );
			METHOD_KEY_REGISTER4( IDebugClientPtrInterpreter, boost::shared_ptr< Base<EncodingT> >, getRunningProcessDescription, no_const_t, UCS("IDebugClientPtr::GetRunningProcessDescription") );
		FACTORY_END_REGISTER

		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("IDebugClientPtr") );
			METHOD_KEY_UNREGISTER2( UCS("IDebugClientPtr::CreateProcess") );
			METHOD_KEY_UNREGISTER3( UCS("IDebugClientPtr::CreateProcess") );
			METHOD_KEY_UNREGISTER1( UCS("IDebugClientPtr::GetRunningProcessSystemIds") );
			METHOD_KEY_UNREGISTER4( UCS("IDebugClientPtr::GetRunningProcessDescription") );
