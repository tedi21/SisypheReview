...
public:
  ...
  boost::shared_ptr< Base<EncodingT> > getTriggeredBreakpoint(const boost::shared_ptr< Base<EncodingT> >& i) const;
		...
		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( DebugEngineInterpreter, UCS("DebugEngine") );
			METHOD_KEY_REGISTER ( DebugEngineInterpreter, boost::shared_ptr< Base<EncodingT> >, initialize, no_const_t, UCS("DebugEngine::Initialize") );
			METHOD_KEY_REGISTER ( DebugEngineInterpreter, boost::shared_ptr< Base<EncodingT> >, terminate, no_const_t, UCS("DebugEngine::Terminate") );
			METHOD_KEY_REGISTER1( DebugEngineInterpreter, boost::shared_ptr< Base<EncodingT> >, dvAlloc, no_const_t, UCS("DebugEngine::DvAlloc") );
			METHOD_KEY_REGISTER2( DebugEngineInterpreter, boost::shared_ptr< Base<EncodingT> >, dvFree, no_const_t, UCS("DebugEngine::DvFree") );
...
METHOD_KEY_REGISTER1( DebugEngineInterpreter, boost::shared_ptr< Base<EncodingT> >, getTriggeredBreakpoint, const_t, C("DebugEngine::GetTriggeredBreakpoint") );
		...
		FACTORY_BEGIN_UNREGISTER
			CLASS_KEY_UNREGISTER  ( UCS("DebugEngine") );
			METHOD_KEY_UNREGISTER ( UCS("DebugEngine::Initialize") );
			METHOD_KEY_UNREGISTER ( UCS("DebugEngine::Terminate") );
			METHOD_KEY_UNREGISTER1( UCS("DebugEngine::DvAlloc") );
			METHOD_KEY_UNREGISTER2( UCS("DebugEngine::DvFree") );
