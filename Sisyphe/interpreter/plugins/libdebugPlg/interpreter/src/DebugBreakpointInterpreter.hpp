...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		shared_ptr< Base<EncodingT> > getDEBUG_BREAKPOINT_CODE() const;

		shared_ptr< Base<EncodingT> > getDEBUG_BREAKPOINT_DATA() const;

		shared_ptr< Base<EncodingT> > getDEBUG_ANY_ID() const;

		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( DebugBreakpointInterpreter, C("DebugBreakpoint") );
			METHOD_KEY_REGISTER ( DebugBreakpointInterpreter, shared_ptr< Base<EncodingT> >, getDEBUG_BREAKPOINT_CODE, const_t, C("DebugBreakpoint::DEBUG_BREAKPOINT_CODE") );
			METHOD_KEY_REGISTER ( DebugBreakpointInterpreter, shared_ptr< Base<EncodingT> >, getDEBUG_BREAKPOINT_DATA, const_t, C("DebugBreakpoint::DEBUG_BREAKPOINT_DATA") );
			METHOD_KEY_REGISTER ( DebugBreakpointInterpreter, shared_ptr< Base<EncodingT> >, getDEBUG_ANY_ID, const_t, C("DebugBreakpoint::DEBUG_ANY_ID") );
