...
namespace word
{
	...
	public:
		...
		~Documents();
		// Assignment operator
		const Documents& operator=(const Documents& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Document();
		// Assignment operator
		const Document& operator=(const Document& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Paragraphs();
		// Assignment operator
		const Paragraphs& operator=(const Paragraphs& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Paragraph();
		// Assignment operator
		const Paragraph& operator=(const Paragraph& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~TablesOfContents();
		// Assignment operator
		const TablesOfContents& operator=(const TablesOfContents& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~TableOfContents();
		// Assignment operator
		const TableOfContents& operator=(const TableOfContents& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Range();
		// Assignment operator
		const Range& operator=(const Range& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Cell();
		// Assignment operator
		const Cell& operator=(const Cell& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Tables();
		// Assignment operator
		const Tables& operator=(const Tables& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Rows();
		// Assignment operator
		const Rows& operator=(const Rows& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Row();
		// Assignment operator
		const Row& operator=(const Row& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Cells();
		// Assignment operator
		const Cells& operator=(const Cells& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Fields();
		// Assignment operator
		const Fields& operator=(const Fields& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Field();
		// Assignment operator
		const Field& operator=(const Field& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~HeadingStyles();
		// Assignment operator
		const HeadingStyles& operator=(const HeadingStyles& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~HeadingStyle();
		// Assignment operator
		const HeadingStyle& operator=(const HeadingStyle& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Selection();
		// Assignment operator
		const Selection& operator=(const Selection& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Characters();
		// Assignment operator
		const Characters& operator=(const Characters& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Find();
		// Assignment operator
		const Find& operator=(const Find& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Words();
		// Assignment operator
		const Words& operator=(const Words& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Sentences();
		// Assignment operator
		const Sentences& operator=(const Sentences& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Columns();
		// Assignment operator
		const Columns& operator=(const Columns& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Column();
		// Assignment operator
		const Column& operator=(const Column& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Window();
		// Assignment operator
		const Window& operator=(const Window& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~View();
		// Assignment operator
		const View& operator=(const View& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~Template();
		// Assignment operator
		const Template& operator=(const Template& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~CommandBars();
		// Assignment operator
		const CommandBars& operator=(const CommandBars& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~CommandBar();
		// Assignment operator
		const CommandBar& operator=(const CommandBar& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~CommandBarControls();
		// Assignment operator
		const CommandBarControls& operator=(const CommandBarControls& copy);
		// Cast operator
		operator IDispatch*() const;
	...
	public:
		...
		~CommandBarControl();
		// Assignment operator
		const CommandBarControl& operator=(const CommandBarControl& copy);
		// Cast operator
		operator IDispatch*() const;
