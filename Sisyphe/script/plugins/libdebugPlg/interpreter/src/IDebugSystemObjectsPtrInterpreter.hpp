...
NAMESPACE_BEGIN(interp)
	...
	public:
		...
		FACTORY_PROTOTYPE1(getCurrentProcessId, InOut< shared_ptr< Base<EncodingT> > >)
		shared_ptr< Base<EncodingT> > getCurrentProcessId(shared_ptr< Base<EncodingT> >& processId);

		// Returns the location of the system data structure describing the current process.
		FACTORY_PROTOTYPE1(getCurrentProcessDataOffset, InOut< shared_ptr< Base<EncodingT> > >)
		shared_ptr< Base<EncodingT> > getCurrentProcessDataOffset(shared_ptr< Base<EncodingT> >& offset);

		// Returns the name of executable file loaded in the current process.
		FACTORY_PROTOTYPE1(getCurrentProcessExecutableName, InOut< shared_ptr< Base<EncodingT> > >)
		shared_ptr< Base<EncodingT> > getCurrentProcessExecutableName(shared_ptr< Base<EncodingT> >& buffer);

		FACTORY_BEGIN_REGISTER
			CLASS_KEY_REGISTER  ( IDebugSystemObjectsPtrInterpreter, C("IDebugSystemObjectsPtr") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, shared_ptr< Base<EncodingT> >, getCurrentProcessId, no_const_t, C("IDebugSystemObjectsPtr::GetCurrentProcessId") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, shared_ptr< Base<EncodingT> >, getCurrentProcessDataOffset, no_const_t, C("IDebugSystemObjectsPtr::GetCurrentProcessDataOffset") );
			METHOD_KEY_REGISTER1( IDebugSystemObjectsPtrInterpreter, shared_ptr< Base<EncodingT> >, getCurrentProcessExecutableName, no_const_t, C("IDebugSystemObjectsPtr::GetCurrentProcessExecutableName") );
	...
	template <class EncodingT>
	bool check_IDebugSystemObjectsPtr(shared_ptr< Base<EncodingT> > const& val, IDebugSystemObjectsPtr& a);

	template <class EncodingT>
	bool reset_IDebugSystemObjectsPtr(shared_ptr< Base<EncodingT> >& val, IDebugSystemObjectsPtr const& a);
