...
template <class EncodingT>
shared_ptr< Base<EncodingT> > WordXMLNodeListInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new WordXMLNodeListInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > WordXMLNodeListInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > WordXMLNodeListInterpreter<EncodingT>::item(const shared_ptr< Base<EncodingT> >& i) const
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > WordXMLNodeListInterpreter<EncodingT>::length() const
{
...
{
	shared_ptr< WordXMLNodeListInterpreter<EncodingT> > value  = dynamic_pointer_cast< WordXMLNodeListInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
