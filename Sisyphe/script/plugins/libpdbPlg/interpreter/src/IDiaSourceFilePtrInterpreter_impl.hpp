...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaSourceFilePtrInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new IDiaSourceFilePtrInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaSourceFilePtrInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaSourceFilePtrInterpreter<EncodingT>::get_checksum(shared_ptr< Base<EncodingT> >& cbData, shared_ptr< Base<EncodingT> >& pcbData, shared_ptr< Base<EncodingT> >& data)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaSourceFilePtrInterpreter<EncodingT>::get_fileName(shared_ptr< Base<EncodingT> >& pRetVal)
{
shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
    BSTR nativePRetVal;
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaSourceFilePtrInterpreter<EncodingT>::get_compilands(shared_ptr< Base<EncodingT> >& ppRetVal)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
{
	shared_ptr< IDiaSourceFilePtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDiaSourceFilePtrInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
