...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::clone() const
{
	return shared_ptr< Base<EncodingT> >(new IDiaEnumLineNumbersPtrInterpreter<EncodingT>(*this));
}
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::invoke(const typename EncodingT::string_t& method, std::vector< shared_ptr< Base<EncodingT> > >& params)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::get_Count(shared_ptr< Base<EncodingT> >& pRetVal)
{
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::item(const shared_ptr< Base<EncodingT> >& index, shared_ptr< Base<EncodingT> >& symbol)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
	long nativeIndex;
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::next(const shared_ptr< Base<EncodingT> >& celt, shared_ptr< Base<EncodingT> >& rgelt, shared_ptr< Base<EncodingT> >& pceltFetched)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::skip(const shared_ptr< Base<EncodingT> >& celt)
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
	unsigned long nativeCelt;
	if (check_numeric(celt, nativeCelt))
...
template <class EncodingT>
shared_ptr< Base<EncodingT> > IDiaEnumLineNumbersPtrInterpreter<EncodingT>::reset()
{
	shared_ptr< Base<EncodingT> > res(new Numeric<EncodingT>());
...
{
	shared_ptr< IDiaEnumLineNumbersPtrInterpreter<EncodingT> > value  = dynamic_pointer_cast< IDiaEnumLineNumbersPtrInterpreter<EncodingT> >(val);
	if (value)
	{
		a = value->getValue();
	}
