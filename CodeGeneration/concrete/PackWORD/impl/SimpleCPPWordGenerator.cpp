	...
	namespace generator {
		...
		SimpleCPPWordGenerator::SimpleCPPWordGenerator()
		{
			...
			CreateWordClass =
                ...
                << line_g(1) << htab_g(1) << "}"
                << line_g(2) << htab_g(1) << ClassName << "& " << ClassName << "::operator=(const " << ClassName << "& copy)"
                << line_g(1) << htab_g(1) << "{"
                << line_g(1) << htab_g(2) << "if (this != &copy)"
                << line_g(1) << htab_g(2) << "{"
                << line_g(1) << htab_g(3) << "if (m_pObject != NULL) m_pObject->Release();"
                << line_g(1) << htab_g(3) << "m_pObject = copy.m_pObject;"
                << line_g(1) << htab_g(3) << "if (m_pObject != NULL) m_pObject->AddRef();"
                << line_g(1) << htab_g(2) << "}"
