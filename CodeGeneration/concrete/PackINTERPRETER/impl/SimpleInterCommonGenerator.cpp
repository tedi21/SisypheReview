	...
	namespace generator {
        ...
        SimpleInterCommonGenerator::SimpleInterCommonGenerator() {
            ...
            InterpreterCheck =
                  ...
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_SBYTE))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_BYTE))]
                  ...
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT16))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT16))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT32))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT32))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT64))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT64))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_SINGLE))]
                  << str_g("check_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_DOUBLE))]
            ...
            InterpreterCheckFunction =
                  ...
                  << str_g("check_numeric<EncodingT, char>")            [attr_g(getIsAttributeTypeHandler(ATTR_SBYTE))]
                  << str_g("check_numeric<EncodingT, unsigned char>")   [attr_g(getIsAttributeTypeHandler(ATTR_BYTE))]
                  ...
                  << str_g("check_numeric<EncodingT, int>")             [attr_g(getIsAttributeTypeHandler(ATTR_INT))]
                  << str_g("check_numeric<EncodingT, unsigned int>")    [attr_g(getIsAttributeTypeHandler(ATTR_UINT))]
                  << str_g("check_numeric<EncodingT, short>")           [attr_g(getIsAttributeTypeHandler(ATTR_INT16))]
                  << str_g("check_numeric<EncodingT, unsigned short>")  [attr_g(getIsAttributeTypeHandler(ATTR_UINT16))]
                  << str_g("check_numeric<EncodingT, long>")            [attr_g(getIsAttributeTypeHandler(ATTR_INT32))]
                  << str_g("check_numeric<EncodingT, unsigned long>")   [attr_g(getIsAttributeTypeHandler(ATTR_UINT32))]
                  << str_g("check_numeric<EncodingT, long long>")       [attr_g(getIsAttributeTypeHandler(ATTR_INT64))]
                  << str_g("check_numeric<EncodingT, unsigned long long>")[attr_g(getIsAttributeTypeHandler(ATTR_UINT64))]
                  << str_g("check_numeric<EncodingT, float>")           [attr_g(getIsAttributeTypeHandler(ATTR_SINGLE))]
                  << str_g("check_numeric<EncodingT, double>")          [attr_g(getIsAttributeTypeHandler(ATTR_DOUBLE))]
            ...
            InterpreterReset =
                  ...
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_SBYTE))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_BYTE))]
                  ...
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT16))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT16))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT32))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT32))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_INT64))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_UINT64))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_SINGLE))]
                  << str_g("reset_numeric")             [attr_g(getIsAttributeTypeHandler(ATTR_DOUBLE))]
            ...
            InterpreterResetFunction =
                  ...
                  << str_g("reset_numeric<EncodingT, char>")              [attr_g(getIsAttributeTypeHandler(ATTR_SBYTE))]
                  << str_g("reset_numeric<EncodingT, unsigned char>")     [attr_g(getIsAttributeTypeHandler(ATTR_BYTE))]
                  ...
                  << str_g("reset_numeric<EncodingT, int>")               [attr_g(getIsAttributeTypeHandler(ATTR_INT))]
                  << str_g("reset_numeric<EncodingT, unsigned int>")      [attr_g(getIsAttributeTypeHandler(ATTR_UINT))]
                  << str_g("reset_numeric<EncodingT, short>")             [attr_g(getIsAttributeTypeHandler(ATTR_INT16))]
                  << str_g("reset_numeric<EncodingT, unsigned short>")    [attr_g(getIsAttributeTypeHandler(ATTR_UINT16))]
                  << str_g("reset_numeric<EncodingT, long>")              [attr_g(getIsAttributeTypeHandler(ATTR_INT32))]
                  << str_g("reset_numeric<EncodingT, unsigned long>")     [attr_g(getIsAttributeTypeHandler(ATTR_UINT32))]
                  << str_g("reset_numeric<EncodingT, long long>")         [attr_g(getIsAttributeTypeHandler(ATTR_INT64))]
                  << str_g("reset_numeric<EncodingT, unsigned long long>")[attr_g(getIsAttributeTypeHandler(ATTR_UINT64))]
                  << str_g("reset_numeric<EncodingT, float>")             [attr_g(getIsAttributeTypeHandler(ATTR_SINGLE))]
                  << str_g("reset_numeric<EncodingT, double>")            [attr_g(getIsAttributeTypeHandler(ATTR_DOUBLE))]
