	...
	namespace generator {
		...
		SimpleCPPInterpreterAccessGenerator::SimpleCPPInterpreterAccessGenerator()
		{
			...
			CreateInterpreterAccessGetOne_R2 =
				...
				<< line_g(1) << "{"
                << line_g(1) << htab_g(1) << "boost::shared_ptr< " << UEntity_R2 << "Interpreter<EncodingT> > res(new " << UEntity_R2 << "Interpreter<EncodingT>());"
                << line_g(1) << htab_g(1) << "clearError();"
                << line_g(1) << htab_g(1) << "try"
                << line_g(1) << htab_g(1) << "{"
                ...
                << line_g(1) << htab_g(2) << "{"
                << line_g(1) << htab_g(3) << "res->value(m_object->getOne" << UEntity_R2 << "(" << ListEntityIDParam_R2(str_g("native") << UAttribute_R2 << ~-CommaParam_R2) << "));"
                << line_g(1) << htab_g(2) << "}"
                << line_g(1) << htab_g(1) << "}"
                << line_g(1) << htab_g(1) << "catch (std::exception& e)"
                << line_g(1) << htab_g(1) << "{"
			...
			CreateInterpreterAccessSelectOne_R2 =
                ...
                << line_g(1) << htab_g(2) << "{"
                << line_g(1) << htab_g(3) << "res->value(m_object->selectOne" << UEntity_R2 << "(" << ListEntityIDParam_R2(str_g("native") << UAttribute_R2 << CommaParam_R2) << "nativeNoWait));"
                << line_g(1) << htab_g(2) << "}"
                << line_g(1) << htab_g(1) << "}"
                << line_g(1) << htab_g(1) << "catch (std::exception& e)"
                << line_g(1) << htab_g(1) << "{"
			...
			CreateInterpreterAccessIsSelected_R2 =
				...
				<< line_g(1) << "{"
                << line_g(1) << htab_g(1) << "boost::shared_ptr< Bool<EncodingT> > res(new Bool<EncodingT>());"
                << line_g(1) << htab_g(1) << "clearError();"
                << line_g(1) << htab_g(1) << "try"
                << line_g(1) << htab_g(1) << "{"
                ...
                << line_g(1) << htab_g(2) << "{"
                << line_g(1) << htab_g(3) << "res->value(m_object->isSelected" << UEntity_R2 << "(native" << UEntity_R2 << "));"
                << line_g(1) << htab_g(2) << "}"
                << line_g(1) << htab_g(1) << "}"
                << line_g(1) << htab_g(1) << "catch (std::exception& e)"
                << line_g(1) << htab_g(1) << "{"
			...
			CreateInterpreterAccessIsAltered_R2 =
                ...
                << line_g(1) << htab_g(2) << "if (check_" << LEntity_R2 << "(" << LEntity_R2 << ", native" << UEntity_R2 << "))"
                << line_g(1) << htab_g(2) << "{"
                << line_g(1) << htab_g(3) << "res->value(m_object->isModified" << UEntity_R2 << "(native" << UEntity_R2 << "));"
                << line_g(1) << htab_g(2) << "}"
                << line_g(1) << htab_g(1) << "}"
                << line_g(1) << htab_g(1) << "catch (std::exception& e)"
                << line_g(1) << htab_g(1) << "{"
