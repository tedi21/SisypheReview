		...
		SimpleHPPInterpreterGenerator::SimpleHPPInterpreterGenerator()
		{
           ...
           CreateForwardDeclaration_R2 =
			...
			CreateInterpreterEntity_R2 =
				...
				<< line_g(1) << htab_g(2) << "CLASS_KEY_REGISTER ( " << UEntity_R2 << "Interpreter, UCS(\"" << UEntity_R2 << "\") );"
				<< line_g(1) << htab_g(2) << "CLASS_KEY_REGISTER" << EntityParamSize_R2 << "( " << UEntity_R2 << "Interpreter, UCS(\"" << UEntity_R2 << "\") );"
				<< CreateAttributeRegister_R2
				<< line_g(1) << htab_g(1) << "FACTORY_END_REGISTER"
				<< line_g(2) << htab_g(1) << "FACTORY_BEGIN_UNREGISTER"
				<< line_g(1) << htab_g(2) << "CLASS_KEY_UNREGISTER ( UCS(\"" << UEntity_R2 << "\") );"
				<< line_g(1) << htab_g(2) << "CLASS_KEY_UNREGISTER" << EntityParamSize_R2 << "( UCS(\"" << UEntity_R2 << "\") );"
			...
			CreateAttributeRegister_R2 =
				((line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << UEntity_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, get" << UAttribute_R2 << ", const_t, UCS(\"" << UEntity_R2 << "::" << UAttribute_R2 << "\") );")
                [!If_IsREF_R2]
				<< (line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER1( " << UEntity_R2 << "Interpreter, void, set" << UAttribute_R2 << ", no_const_t, UCS(\"" << UEntity_R2 << "::" << UAttribute_R2 << "\") );")
				[If_IsWriteAttribute_R2]
				<< (line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << UEntity_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, get" << UAttribute_R2 << ", no_const_t, UCS(\"" << UEntity_R2 << "::" << UAttribute_R2 << "\") );" 
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << UEntity_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, has" << UAttribute_R2 << ", const_t, UCS(\"" << UEntity_R2 << "::Has" << UAttribute_R2 << "\") );" 
				<< line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << UEntity_R2 << "Interpreter, void, remove" << UAttribute_R2 << ", no_const_t, UCS(\"" << UEntity_R2 << "::remove" << UAttribute_R2 << "\") );")
				[If_IsREF_R2])
				[attr0, attrN]
				<< ListRelationN_R2(
                   line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER1( " << URelation1_R2 << "Interpreter, void, remove" << URelationNName_R2 << ", no_const_t, UCS(\"" << URelation1_R2 << "::remove" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER2( " << URelation1_R2 << "Interpreter, void, insert" << URelationNName_R2 << ", no_const_t, UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER1( " << URelation1_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, get" << URelationNName_R2 << ", no_const_t, UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << URelation1_R2 << "Interpreter, void, clear" << URelationNName_R2 << "s, no_const_t, UCS(\"" << URelation1_R2 << "::Clear" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << URelation1_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, has" << URelationNName_R2 << "s, const_t, UCS(\"" << URelation1_R2 << "::Has" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_REGISTER ( " << URelation1_R2 << "Interpreter, boost::shared_ptr< Base<EncodingT> >, " << LRelationNName_R2 << "sCount, const_t, UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "sCount\") );");

			CreateAttributeUnRegister_R2 =
				(line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << UEntity_R2 << "::" << UAttribute_R2 << "\") );"
				<< (line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER1( UCS(\"" << UEntity_R2 << "::" << UAttribute_R2 << "\") );")
				[If_IsWriteAttribute_R2]
				<< (line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << UEntity_R2 << "::Has" << UAttribute_R2 << "\") );"
				<< line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << UEntity_R2 << "::remove" << UAttribute_R2 << "\") );")
				[If_IsREF_R2])
				[attr0, attrN]
				<< ListRelationN_R2(
                   line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER1( UCS(\"" << URelation1_R2 << "::remove" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER2( UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER1( UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << URelation1_R2 << "::Clear" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << URelation1_R2 << "::Has" << URelationNName_R2 << "s\") );"
                << line_g(1) << htab_g(2) << "METHOD_KEY_UNREGISTER ( UCS(\"" << URelation1_R2 << "::" << URelationNName_R2 << "sCount\") );");
