...
namespace gen {
    ...
    class insertion
    : public collection_expr < insertion<CompositorT1, CompositorT2> >
    {
    public:
        typedef insertion<CompositorT1,CompositorT2> self_t;
        ...
        insertion(collection_expr<CompositorT1> const& e1, collection_expr<CompositorT2> const& e2)
...
#include "impl/insertion_impl.hpp"
