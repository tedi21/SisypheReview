...
#ifndef INTERSECT_EXPR_HPP
#define INTERSECT_EXPR_HPP
...
namespace gen {
    ...
    class intersect_expr
    : public collection_expr < intersect_expr<CompositorT1, CompositorT2> >
    {
    public:
        typedef intersect_expr<CompositorT1,CompositorT2> self_t;
        ...
        intersect_expr(collection_expr<CompositorT1> const& e1, collection_expr<CompositorT2> const& e2)
...
#include "impl/intersect_expr_impl.hpp"
